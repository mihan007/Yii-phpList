...
$lan = array(
  ...
  'Dec' => 'Dec',
  # from sendemaillib
  'sendingtextonlyto' => 'Csak szöveg küldése a következőknek',
  'sendingmessage' => 'Üzenet küldése',
  'withsubject' => 'melynek tárgya',
  'to' => 'címzett',
  'admininitfailure' => 'Az adminisztrátor hitelesítésének inicializálása nem sikerült',
  'yourpassword' => 'Az Ön phplist jelszava',
  'yourpasswordis' => 'Az Ön jelszava',
  'passwordsent' => 'Jelszavát megküldtük e-mailben',
  'cannotsendpassword' => 'Nem lehet elküldeni a jelszót',
  'ipchanged' => 'Az IP-címe megváltozott. Kérjük, hogy biztonsági okokból jelentkezzen be újra',
  'goodbye' => 'viszlát,',
  'goodmorning' => 'szép napot,',
  'goodafternoon' => 'jó napot,',
  'goodevening' => 'jó estét,',
  'safemodewarning' => 'Biztonsági módban (safe mode) nem fog minden a vártnak megfelelően működni',
  'magicquoteswarning' => 'Jobban fognak működni a dolgok, ha a PHP magic_quotes_gpc = <b>be</b>',
  'magicruntimewarning' => 'Jobban fognak működni a dolgok, ha a PHP magic_quotes_runtime = ki',
  'noxml' => 'Ön az RSS használatával próbálkozik, azonban a PHP nem tartalmazza az XML-t',
  'warnopenbasedir' => 'Az open_basedir korlátozások érvényben vannak, ez lehet az oka a következő figyelmeztetésnek',
  'warnattachmentrepository' => 'A melléklettároló nem létezik, vagy nem írható',
  'nofpdf' => 'Ön az FPDF betöltése nélkül próbálkozik a PDF-támogatás használatával',
  'warnpageroot' => 'A beállításokban megadott oldalgyökér nem egyezik a jelenlegi hellyel<br/>Ellenőrizze a konfigurációs fájlt.',
  'pagenotfoundinplugin' => 'Sajnos ez az oldal nem található a beépülő modulban',
  'notimplemented' => 'Sajnos még nem dolgoztuk ki',
  'noaccess' => 'Önnek nincs elegendő joga az ehhez az oldalhoz történő hozzáféréshez',
  'nohelpavailable' => 'Sajnos még nincs súgója ennek a témának: ',
  ...
  # added 2.10.2
  'globalvulnwarning' => 'Az Ön PHP-verziójában van egy nagyobb biztonsági probléma.<br/>A legjobb a legújabb PHP-verzióra frissítenie. Erről a problémáról <a href="http://www.hardened-php.net/globals-problem">bővebben</a>.',
