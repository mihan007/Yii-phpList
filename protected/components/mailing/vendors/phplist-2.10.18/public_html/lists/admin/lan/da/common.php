...
$lan = array(
  ...
  'Dec' => 'Dec',
  # from sendemaillib
  'sendingtextonlyto' => 'Sender kun tekst til',
  'sendingmessage' => 'Sender besked',
  'withsubject' => 'med emne',
  'to' => 'til',
  'admininitfailure' => 'Admin <i>Godkendelses initialisering</i> fejl',
  'yourpassword' => 'Dit kodeord til phplist',
  'yourpasswordis' => 'Dit kodeord er',
  'passwordsent' => 'Dit kodeord er sendt som email',
  'cannotsendpassword' => 'Kunne ikke sende kodeord',
  'ipchanged' => 'Din IP adresse er &aelig;ndret. Af sikkerhedsgrunde log venligst ind igen',
  'goodbye' => 'farvel',
  'goodmorning' => 'god morgen',
  'goodafternoon' => 'god eftermiddag',
  'goodevening' => 'god aften',
  'safemodewarning' => 'I safe mode, vil alt ikke fungere som forventet',
  'magicquoteswarning' => 'Det vil virke bedre med PHP magic_quotes_gpc = <b>on</b>',
  'magicruntimewarning' => 'Det vil virke bedre med PHP magic_quotes_runtime = off',
  'noxml' => 'Du fors&oslash;ger at bruge RSS, men XML er ikke inkluderet i din PHP',
  'warnopenbasedir' => 'open_basedir restriktioner er sat aktive, som muligvis vil for&aring;rsage den n&aelig;ste advarsel',
  'warnattachmentrepository' => 'Folderen til vedh&aelig;ftelser enten ikke eksisterer eller er ikke gjort skrivbar',
  'nofpdf' => 'Du fors&oslash;ger at bruge PDF support uden at FPDF er indl&aelig;st',
  'warnpageroot' => 'Rod-folderen i din config svarer ikke til den nuv&aelig;rende position<br/>Tjek din config fil.',
  'pagenotfoundinplugin' => 'Desv&aelig;rre, denne side blev ikke fundet i denne plugin',
  'notimplemented' => 'Desv&aelig;rre, er endnu ikke implementeret',
  'noaccess' => 'Du har ikke tilladelse til at se denne side',
  'nohelpavailable' => 'Desv&aelig;rre, hj&aelig;lp til dette emne er ikke tilg&aelig;ngelig endnu: ',
  ...
  # added 2.10.2
  'globalvulnwarning' => 'Din version af PHP har en st&oslash;rre sikkerheds brist.<br/>Det er bedst at opgradere til den seneste version af PHP. <a href="http://www.hardened-php.net/globals-problem">L&aelig;s mere</a> om emnet.',
